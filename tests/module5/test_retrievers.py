...
def test_semantic_retriever_returns_results():
    ...
    with (
        patch("modules.module5_retrieve.semantic.get_client", return_value=mock_client),
...
def test_lexical_retriever_returns_results():
    ...
    with (
        patch("modules.module5_retrieve.lexical.get_client", return_value=mock_client),
        patch(
            "modules.module5_retrieve.sparse.generate_sparse_vectors",
...
def test_hybrid_retriever_returns_results():
    ...
    with (
        patch("modules.module5_retrieve.hybrid.get_client", return_value=mock_client),
        patch("modules.module5_retrieve.hybrid.asyncio") as mock_asyncio,
        patch(
            "modules.module3_embed.sparse.generate_sparse_vectors",
