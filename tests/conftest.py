...
def sample_paper() -> dict:
    return {
        ...
        'authors':    [{'name': 'Jane Smith', 'affiliation': 'Harvard'}, {'name': 'John Doe', 'affiliation': 'MIT'}],
        ...
        'sections': [
            ...
            },
            {
                ...
                'figure_refs': ['fig1'], 'table_refs': ['tbl1'],
            },
        ],
        'figures': [
            {
                'fig_id': 'fig1', 'caption': 'Kaplan-Meier survival curve',
                'coords': {'page': 2, 'x': 50.0, 'y': 100.0, 'w': 200.0, 'h': 150.0},
                's3_img_key': '', 'description': 'Survival curve showing...',
            }
        ],
        'tables': [
            {
                'table_id': 'tbl1', 'caption': 'Baseline characteristics',
                'markdown': '| Variable | N |\n| --- | --- |\n| Age | 65 |',
            }
        ],
        'source_db':     'pubmed',
